...
FOREIGN KEY
            ...
            VALUES
                ("Junior Software developer", 75000.00, 1);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Senior Software developer", 125000.00, 1);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
            ...
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Lead accountant", 90000.00, 2);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Hiring manager", 55000.00, 3);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Quality assurance engineer", 120000.00, 4);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Marketing director", 120000.00, 5);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Marketing and sales associate", 55000.00, 5);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Data scientist", 140000.00, 6);
            INSERT INTO role
                (title, salary, department_id)
            VALUES
                ("Research lead", 50000.00, 6);
